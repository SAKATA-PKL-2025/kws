...
<?php $component->withAttributes([]); ?>
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div class="flex-shrink-0">
                <h2 class="text-xl font-bold text-gray-950 dark:text-white"><?php echo e($greeting); ?>, <?php echo e($userName); ?>!</h2>
            ...
            <div class="flex flex-wrap gap-3 ml-auto">
                ...
                <a href="<?php echo e($action['url']); ?>" 
                   <?php if(isset($action['external']) && $action['external']): ?> target="_blank" <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\kws\resources\views/filament/widgets/quick-actions.blade.php ENDPATH**/ ?>